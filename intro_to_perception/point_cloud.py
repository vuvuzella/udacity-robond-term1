...
# Read in the image and depth map as separate assets
...
# Use 1.1 to send poorly mapped pixels back 10 percent
# farther thatn the farthest correctly mapped point
...
for x in range(cols):
    for y in range(rows):
        if (x % pixel_cut == 0 and y % pixel_cut == 0):
            ...
            # TODO: DONE
            # Get point color for pixel, (R, G, B)
